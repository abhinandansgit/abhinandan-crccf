...
// Import React hooks for state, lifecycle, references and optimization

import { useState, useEffect, useRef, useCallback } from 'react';


// Import icons used across UI for visual representation
import {
...
// Import Navbar component for consistent top navigation
import Navbar from '../components/Navbar';
// Import services data and category definitions
...
function ServiceCard({ service, index, onLearnMore }) {
  const ref = useRef(null);  // reference to DOM element for observer
  const [visible, setVisible] = useState(false);  // controls animation visibility

  // Watch for when card enters the screen and show it with animation
  useEffect(() => {
